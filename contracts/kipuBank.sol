...
/// @title KipuBank - Contrato inteligente de depósito y retiro de ETH
/// @author Andrés C.
/// @notice Este contrato permite a los usuarios depositar y retirar ETH con límites establecidos.
/// @dev Se siguen buenas prácticas de seguridad, patrón checks-effects-interactions y reentrancy guard.
